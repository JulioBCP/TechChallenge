...
import com.fiap.techchallenge.carrental.pagamento.DTO.CartaoClienteDTO;
...
public class PagamentoService {
    ...
    public ResponseEntity<String> efetuarPagamento(Cliente cliente, Veiculo veiculo, CartaoClienteDTO cartaoClienteDTO,
