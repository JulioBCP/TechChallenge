package com.fiap.techchallenge.carrental.aluguel.utils;
...
import com.fiap.techchallenge.carrental.aluguel.entity.enumerations.ValoresDiariasModeloEnum;
...
public class ContratoCalculator {
    ...
    public static double calcularValorContrato(LocalDate dataInicio, LocalDate dataFim, TipoVeiculoEnum tipoVeiculo){
